# SignalTestApp - 构建和部署指南

## 项目概述

SignalTestApp 是一个 Android 信号测试应用，用于监测和记录 2G/3G/4G/5G 网络信号强度，并支持拍照记录功能。
...
# 对齐 APK
zipalign -v 4 app/build/outputs/apk/release/app-release-unsigned.apk SignalTestApp-release.apk
```
...
- GitHub: https://github.com/Charlielian/SignalTestApp
- Issues: https://github.com/Charlielian/SignalTestApp/issues
